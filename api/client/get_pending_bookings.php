...
try {
    ...
    // ✅ FIXED: Filter bookings by user ID for clients
    // Admins and organizers can see all bookings, clients only see their own
    $query = "SELECT 
                b.id,
                b.booking_reference,
                b.booking_type,
    ...
    $countQuery = "SELECT COUNT(*) as total FROM bookings WHERE status = :status";
    if ($userRole === 'client') {
        $countQuery .= " AND client_id = :user_id";
    }
